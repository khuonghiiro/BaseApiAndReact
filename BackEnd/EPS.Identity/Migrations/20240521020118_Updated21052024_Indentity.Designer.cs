...
namespace EPS.Identity.Migrations
{
    ...
    [Migration("20240521020118_Updated21052024_Indentity")]
    partial class Updated21052024_Indentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPS.Identity.Data.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPS.Identity.Data.Entities.User", b =>
                {
                    ...
                    b.HasOne("EPS.Identity.Data.Department", "User_DepartmentId")
                        .WithMany("User_DepartmentIds")
                        .HasForeignKey("DepartmentId");

                    b.Navigation("DeletedUser");

                    b.Navigation("User_DepartmentId");
                });
            ...
            modelBuilder.Entity("EPS.Identity.Data.Department", b =>
                {
                    b.Navigation("User_DepartmentIds");
                });
